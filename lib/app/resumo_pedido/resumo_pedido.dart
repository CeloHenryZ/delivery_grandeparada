...
import 'package:loja_grandeparada/app/pdf/pdf_view.dart';
import 'package:loja_grandeparada/app/providers/itens_pedido_list.dart';
import 'package:loja_grandeparada/app/widgets/cardResumo.dart';
import 'package:loja_grandeparada/app/widgets/colors.dart';
import 'package:loja_grandeparada/database/database.dart';
...
class ResumoPedidoState extends State<ResumoPedido> {
  ...
  var mensagemEntrega;
  var enderecoLoja =
      'Avenida Pernambuco, 813, Morada da Serra	Cuiabá/MT	78055-428';
  ...
  getPedidoById() async {
    ...
    try {
      ...
      print(response.body);
      print(jsonDecode(response.body)['cliente']);
